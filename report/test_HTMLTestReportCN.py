...
class APITestCase(unittest.TestCase):
    ...
    def testCase3(self):
        print("打印: APITestCase testCase3 start")
        self.assertEqual(5, 5, "testError")
        print("打印: APITestCase testCase3 end")

    def testCase4(self):
        print(" 打印: APITestCase testCase4 start")
        self.assertEqual(2, 1, "测试错误")
    def testCase5(self):
...
if __name__ == '__main__':
    #确定生成报告的路径
    filePath = r'D:\vsworkspace\2018年10月\AutoInterface\20181022自动化接口3\reportHtml\HTMLTestReportCN.html'
    fp = open(filePath,'wb')
    #生成报告的Title,描述
